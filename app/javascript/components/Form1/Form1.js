...
const Form1 = (props) => {
  ...
  let totalsF = setTotals(valuesF)
  let totalsS = setTotals(valuesS)
        ...
        <table className="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>140</td>
              <td><input type="number" name='c140' onChange={handleChangeF} /></td>
              <td><input type="number" name='c140' onChange={handleChangeS} /></td>
            </tr>
            <tr>
              <th scope="row">Долгосрочные финансовые вложения</th>
              <td>150</td>
              <td><input type="number" name='c150' onChange={handleChangeF} /></td>
            ...
            <tr className="table-secondary">
              ...
              <td>190</td>
              <td>{totalsF['c190'] ? totalsF['c190'] : ''}</td>
              <td>{totalsS['c190'] ? totalsS['c190'] : ''}</td>
            </tr>
            ...
            <tr>
              ...
              <td>210</td>
              <td><input type="number" name='c210' onChange={handleChangeF} /></td>
            ...
            <tr>
              ...
              <td>240</td>
              <td><input type="number" name='c240' onChange={handleChangeF} /></td>
            ...
            <tr>
              ...
              <td>270</td>
              <td><input type="number" name='c270' onChange={handleChangeF} /></td>
              <td><input type="number" name='c270' onChange={handleChangeS} /></td>
            </tr>
            <tr>
              <th scope="row">Прочие краткосрочные активы </th>
              <td>280</td>
              <td><input type="number" name='c280' onChange={handleChangeF} /></td>
              <td><input type="number" name='c280' onChange={handleChangeS} /></td>
            </tr>
            <tr className="table-secondary">
              <th scope="row">ИТОГО по разделу II </th>
              <td>290</td>
              <td>{totalsF['c290'] ? totalsF['c290'] : ''}</td>
              <td>{totalsS['c290'] ? totalsS['c290'] : ''}</td>
            </tr>
            <tr className="table-secondary">
              <th scope="row">БАЛАНС (190+290) </th>
              <td>300</td>
              <td>{totalsF['c300'] ? totalsF['c300'] : ''}</td>
              <td>{totalsS['c300'] ? totalsS['c300'] : ''}</td>
            </tr>
          </tbody>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>510</td>
              <td><input type="number" name='c510' onChange={handleChangeF} /></td>
            ...
            <tr>
              ...
              <td>520</td>
              <td><input type="number" name='c520' onChange={handleChangeF} /></td>
              <td><input type="number" name='c520' onChange={handleChangeS} /></td>
            </tr>
            <tr>
              <th scope="row">Отложенные налоговые обязательства</th>
              <td>530</td>
              <td><input type="number" name='c530' onChange={handleChangeF} /></td>
              <td><input type="number" name='c530' onChange={handleChangeS} /></td>
            </tr>
            <tr>
              <th scope="row">Доходы будущих периодов </th>
              <td>540</td>
              <td><input type="number" name='c540' onChange={handleChangeF} /></td>
              <td><input type="number" name='c540' onChange={handleChangeF} /></td>
            </tr>
            <tr>
              <th scope="row">Резервы предстоящих платежей</th>
              <td>550</td>
              <td><input type="number" name='c550' onChange={handleChangeF} /></td>
              <td><input type="number" name='c550' onChange={handleChangeF} /></td>
            </tr>
            <tr>
              <th scope="row">Прочие долгосрочные обязательства</th>
              <td>560</td>
              <td><input type="number" name='c560' onChange={handleChangeF} /></td>
              <td><input type="number" name='c560' onChange={handleChangeF} /></td>
            </tr>
            <tr className="table-secondary">
              <th scope="row">ИТОГО по разделу IV</th>
              <td>590</td>
              <td>{totalsF['c590'] ? totalsF['c590'] : ''}</td>
              <td>{totalsS['c590'] ? totalsS['c590'] : ''}</td>
            </tr>
            <tr className="table-primary">
